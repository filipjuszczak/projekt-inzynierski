...
import { getMoviesPromise } from "@/app/(staff)/staff/dashboard/(management)/movies/data";
import { getRoomsPromise } from "@/app/(staff)/staff/dashboard/(management)/rooms/data";
